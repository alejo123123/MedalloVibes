...
<body>
    ...
    <div class="bg-blue-300 shadow-md p-8 mx-auto mt-40 h-auto rounded max-w-md w-full">
        <h2 class="text-4xl text-center mb-4">Iniciar Seccion</h2>
        <form method="POST">
            <div class="mb-4">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-6 " name="registrar3" value="registrar3">Registrar</button>
            <?php 
